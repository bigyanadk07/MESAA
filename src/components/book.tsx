      ...
      <div className='grid grid-cols-3 mt-20 mb-20'>
        <div className='  col-span-2 bg-black p-10 shadow-xl'>
            ...
            <form>
                ...
                <div className='px-10 py-5 mb-10'>
                  <textarea className='inputBg w-full p-5' placeholder='Enter Your Message...' name="textarea" id="txtarea" rows="5"/>
                </div>
                <button className='w-full bookBtn px-10 py-2 font6'>Book a Table</button>
            </form>
        </div>
        ...
        <div className='col-span-1 inputBg'>
          ...
          <div className='mx-5'>
              ...
              <rect x="31.6" y="3" transform="matrix(0.7071 0.7071 -0.7071 0.7071 14.7528 -22.8645)" fill="none" stroke="#e4c590" stroke-width="0.75" stroke-miterlimit="10" width="6.8" height="6.8"/>
              <rect x="58.7" y="3" transform="matrix(0.7071 0.7071 -0.7071 0.7071 22.699 -42.0484)" fill="none" stroke="#e4c590" stroke-width="0.75" stroke-miterlimit="10" width="6.8" height="6.8"/>

              <line fill="none" stroke="#e4c590" stroke-width="0.75" stroke-miterlimit="10" x1="3.2" y1="6.4" x2="30.2" y2="6.4"/>
              <circle fill="#e4c590" cx="2.6" cy="6.4" r="2.5"/>
              <line fill="none" stroke="#e4c590" stroke-width="0.75" stroke-miterlimit="10" x1="93.9" y1="6.4" x2="66.9" y2="6.4"/>
