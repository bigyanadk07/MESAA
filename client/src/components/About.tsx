...
import AboutMain from './assets/aboutus.png'
...
const About:React.FC = () => {
  return (
    <div className='font3 text-white background'>
      <Navbar/>
      <div className='grid grid-cols-3  mx-20 my-10'>
        <div className='col-span-2 text-center  min-h-full'>
            ...
            {/* Bottom Part */}
            <div className='mx-10 max-w-4xl mb-10 background'>
            <h1 className='font-bold text-2xl text-left mt-10 mb-5'>Why Customers Prefer Us</h1>
            <div className='  px-6 py-8 rounded-lg grid grid-cols-2 gap-8'>
